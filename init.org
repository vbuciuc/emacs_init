...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package org-agenda
    :config
    (setq org-agenda-files (list "~/.org/personal.org" "~/.org/work.org" "~/.org/workish.org" "~/.org/gtd.org" "~/.org/refile.org" "~/.org-jira/APIGOV.org" "~/.org/snippets.org"))
    :bind
    ("C-c C-a" . 'org-agenda))
#+END_SRC
